...
//		startService(serviceIntent);
		...
		bt.setOnDataReceivedListener(new OnDataReceivedListener() {
			public void onDataReceived(byte[] data, String message) {
				...
				Toast.makeText(SimpleActivity.this, "CONFIGURATION MODE:"+message, Toast.LENGTH_SHORT).show();
				//closure?
				bt.setOnDataReceivedListener(new OnDataReceivedListener() {
					public void onDataReceived(byte[] data, String message) {

						Toast.makeText(SimpleActivity.this, "DATA MODE:"+message, Toast.LENGTH_SHORT).show();
					}
				});
