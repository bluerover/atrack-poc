    ...
    private class TimeoutThread extends Thread{
        ...
        public void run(){
            do{
                try {
                    if(!this.flag){
                        //TODO send timeout exception
                    }
                    this.flag = false;
                    this.sleep(this._timeout);
        ...
        public synchronized  void updateTimerFlag(){
            this.flag = true;
        }
    }
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                if(BluetoothService.this.isAndroid)
                    tmp = device.createRfcommSocketToServiceRecord(UUID.fromString(device.getUuids()[0].toString()));
                else
            ...
            while (true) {
                try {
                    ...
                    if(data == 0x0A) { 
                        ...
                        //TODO: send to greenrobot eventbus
